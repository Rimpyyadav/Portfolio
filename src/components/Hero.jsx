        ...
        <div className="border-b border-neutral-900 pb-4 lg:mb-35" >
            <div className="flex flex-wrap">
                ...
                <div className="flex flex-col items-center lg:items-start" >
                    ...
                    initial="hidden"
                    animate="visible"
                    className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl" >Rimpy Yadav</motion.h1>
                ...
                src={profilpic} style={{ height: '500px' , width: '350px' }}  alt="Profile Pic" />
                </div>
                </div>
            </div>
        </div>
